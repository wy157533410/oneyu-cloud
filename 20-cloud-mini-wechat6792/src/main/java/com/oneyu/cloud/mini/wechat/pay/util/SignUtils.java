package com.oneyu.cloud.mini.wechat.pay.util;
...
public class SignUtils {
    ...
    public static String md5(Map<String, String> data, String key) {
        ...
        String sign = SecureUtil.md5(buf.toString()).toUpperCase();
        return sign;
    }
...
//        return RSA.encrypt(content, privateKey);
        return SecureUtil.rsa(privateKey.getBytes(), "".getBytes()).encryptStr(content, KeyType.PrivateKey);
    }
    ...
    public static boolean checkMd5Sign(String content, String sign, String key) {
        ...
        return SecureUtil.md5(buf.toString()).equalsIgnoreCase(sign);
    }
    ...
    public static boolean checkRSASign(String content, String sign, String publicKey) {
        ...
        return SecureUtil.rsa("".getBytes(), publicKey.getBytes()).encryptStr(content, KeyType.PublicKey).equalsIgnoreCase(sign);  
